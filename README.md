...
# Notes
This Repo intended as fork to fix some bug that meet our requirements, also we suggest to check original repo [here](https://github.com/pedroslopez/whatsapp-web.js) 
